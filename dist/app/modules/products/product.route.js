...
const searchProductsMiddleware_1 = __importDefault(require("../../middlewares/searchProductsMiddleware"));
const router = express_1.default.Router();
router.post("/", product_controller_1.ProductControllers.createProduct);
router.get("/", searchProductsMiddleware_1.default, product_controller_1.ProductControllers.getAllProduct);
